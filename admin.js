...
let departments = [
    {
        ...
        name: "قسم التطعيمات",
        icon: "fas fa-syringe",
        description: "تطعيمات سنوية ودورية للحماية من الأمراض"
    },
    {
        id: 2,
        name: "قسم الجراحة",
        icon: "fas fa-cut",
        description: "جراحات عامة وتخصصية للحيوانات الأليفة"
    },
    {
        id: 3,
        name: "قسم التشخيص",
        icon: "fas fa-stethoscope",
        description: "أحدث أجهزة الأشعة والتحاليل المخبرية"
    },
    {
        id: 4,
        name: "قسم التجميل",
        icon: "fas fa-paw",
        description: "خدمات التجميل والعناية بالحيوانات"
    }
];
...
let services = [
    ...
    },
    {
        id: 3,
        departmentId: 2,
        name: "جراحة تعقيم القطط",
        description: "جراحة تعقيم للقطط مع متابعة ما بعد الجراحة",
        price: 120,
